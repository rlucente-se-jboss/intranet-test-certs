...
echo 'Make sure to install /root/ca/certs/ca.cert.pem on every client'
cp intermediate/certs/intermediate.cert.pem intermediate/certs/deploy-ca-chain.cert.pem
